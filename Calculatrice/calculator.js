...
["_add","_subtract","_multiply","_divide","_modulo","_factorial","_power","_squareRoot","_memory","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
var _modulo = Module['_modulo'] = createExportWrapper('modulo', 2);
var _factorial = Module['_factorial'] = createExportWrapper('factorial', 1);
var _power = Module['_power'] = createExportWrapper('power', 2);
var _squareRoot = Module['_squareRoot'] = createExportWrapper('squareRoot', 1);
